...
_SYSTEM_PROMPT = (
    ...
    "This is the branded name the building or campus is known by — e.g. 'The Stratum', 'Domain Tower', "
    "'Capital Ridge', '360 Rosewood'. Look for phrases like 'at [Name]', 'located at [Name]', 'lease at [Name]', "
    "or a project/building name mentioned near the address. "
    "If the document only contains an address (e.g. '11044 Research Blvd') with no branded name, set to null. "
    "Never use the street address as the building_name.\n"
    "- premises.address: the full street address including suite/floor, city, state, zip.\n"
