...
_SYSTEM_PROMPT = (
    ...
    "- term_months: extract ONLY from the dedicated 'Lease Term:' or 'Initial Term:' field. "
    "IGNORE month counts inside ROFR, expansion, holdover, renewal-notice, or early-access clauses "
    "(e.g. 'within the first eighteen (18) months of the Primary Lease Term' refers to an expansion right, "
    "NOT the lease term). Word-form + digit patterns count: 'Sixty-six(66) months' = 66.\n"
    "- commencement_date: a sentence like 'assuming Tenant and Landlord execute a lease on or before "
    "5/1/2026, [the Commencement Date] is expected to be January 1st, 2027' means commencement_date = "
    "2027-01-01. The 5/1/2026 date is a lease-execution DEADLINE, NOT the commencement date. "
    "Always prefer the 'expected to be' or 'substantially complete' date over any 'on or before' / "
    "'execute by' date when extracting commencement.\n"
    "- parking: extract parking_rate_monthly ($/spot/space/month) as a number. "
    "Example: 'initial cost of $185 per spot per month' → parking_rate_monthly = 185. "
    "Parking abatement: 'The first twenty four (24) months of parking costs shall be abated' → "
    "add a parking_abatement entry with start_month=0, end_month=23.\n"
