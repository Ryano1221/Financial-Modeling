        ...
        <section className="section-panel p-6 sm:p-10 space-y-8">
            <div className="space-y-3">
              ...
              <div className="surface-card brand-panel space-y-2 p-4">
                ...
                <p className="text-sm text-slate-300">17. If the issue involved AI tour briefs or AI proposal-request actions, include the exact card you used, the prompt or button clicked, and the response you expected to see.</p>
                <p className="text-sm text-slate-300">18. If a follow-up task created from a tour card looked wrong, include the task title, expected due date, and the tour record it should have come from.</p>
                <p className="text-sm text-slate-300">19. If drag-and-drop on the shortlist or tour boards did not work, include which card you dragged, the origin column, the target column, and whether the status changed after drop.</p>
                <p className="text-sm text-slate-300">20. If a saved board view loaded the wrong slice, include the deal, saved view name, expected building or broker filter, and the date window you expected.</p>
                <p className="text-sm text-slate-300">21. If a post-tour recap draft looked off, include the completed tour card, attendees, notes, and the specific subject or body text you expected the AI draft to reflect.</p>
                <p className="text-sm text-slate-300">22. If shortlist owner or tour assignee updates did not stick, include the card, the expected owner or assignee, and whether the change disappeared after refresh or deal switch.</p>
                <p className="text-sm text-slate-300">23. If a team-wide saved board view showed the wrong cards, include whether it was saved as deal-only or team-wide, the active deal, and the exact building, people, and date filters expected.</p>
                <p className="text-sm text-slate-300">24. If Send to Client or Log to Deal Activity on a recap draft misbehaved, include the deal, tour card, client email on file, and whether the issue happened before or after the AI draft was generated.</p>
                <p className="text-sm text-slate-300">25. If team-wide view permissions looked wrong, include your signed-in email, expected role, expected team, and whether the view should have been editable or read-only.</p>
                <p className="text-sm text-slate-300">26. If bulk reassignment changed the wrong cards, include how many shortlist or tour cards were selected, the owner or assignee applied, and whether the visible filter slice matched the selected set.</p>
                <p className="text-sm text-slate-300">27. If backend recap sending failed, include the client email on file, whether you were signed in, and whether the AI draft generated correctly before the send action was attempted.</p>
              </div>
            </div>
