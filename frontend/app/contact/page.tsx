        ...
        <section className="section-panel p-6 sm:p-10 space-y-8">
            <div className="space-y-3">
              ...
              <div className="surface-card brand-panel space-y-2 p-4">
                ...
                <p className="text-sm text-slate-300">3. If it is a dashboard issue, note whether it happened in the start-here flow, the priority snapshot, the current-focus panel, or the advanced workspace.</p>
                ...
                <p className="text-sm text-slate-300">5. For upload issues, note the file type, whether extraction completed, whether the guided extractor auto-opened the comparison summary, and whether the document was saved without being marked parsed.</p>
                <p className="text-sm text-slate-300">5a. If the problem is reopening a file after refresh, include whether you are on the same browser and device that uploaded it and whether the file opened immediately after upload but failed later.</p>
                <p className="text-sm text-slate-300">5b. For Word proposal or counter uploads, include the exact heading labels used for economics sections, especially if the document uses layouts like Primary Lease Term, Rent Abatement Period, or Base Annual Net Rental Rate.</p>
                <p className="text-sm text-slate-300">5c. If the file is a landlord response or tenant counter that still includes the original RFP pages above the response terms, mention that too so support can verify the response-layer parsing path.</p>
                ...
                <p className="text-sm text-slate-300">7a. If a deleted building or document came back after refresh, include the client workspace, the exact building name or document filename, whether you were signed in, and whether it reappeared immediately or only after sync.</p>
                ...
                <p className="text-sm text-slate-300">11. For CRM intake issues, mention the building text you typed, whether an autofill suggestion appeared, whether you opened intake from the simple CRM landing or the advanced workspace, and whether you were trying to add a new building.</p>
                ...
                <p className="text-sm text-slate-300">13a. If a document uploaded in Financial Analyses did not jump into the comparison summary automatically, include whether the file came through the guided extract panel, the tab-wide drag-and-drop overlay, the module document center, or an existing client-document selection, and whether the workspace showed an extraction error, stale saved data, or any scenario cards at all.</p>
                <p className="text-sm text-slate-300">13b. If the Financial Analyses page still felt cluttered or something appeared in the wrong place, mention whether the issue was in the top intake area, the option cards, the active editor, or the exports and analytics section.</p>
