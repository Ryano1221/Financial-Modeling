        ...
        <section className="section-panel p-6 sm:p-10 space-y-8">
            <div className="space-y-3">
              ...
              <div className="surface-card brand-panel space-y-2 p-4">
                ...
                <p className="text-sm text-slate-300">13b. If the Financial Analyses page still felt cluttered or something appeared in the wrong place, mention whether the issue was in the top intake bar, the scenario list, the scenario editor, or the outputs and analytics section.</p>
