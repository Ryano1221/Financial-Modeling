        ...
        <section className="section-panel p-6 sm:p-10 space-y-8">
            <div className="space-y-3">
              ...
              <div className="surface-card brand-panel space-y-2 p-4">
                ...
                <p className="text-sm text-slate-300">5. For upload issues, note the file type, whether extraction completed, whether the guided extractor moved into manual review, and whether the document was saved without being marked parsed.</p>
