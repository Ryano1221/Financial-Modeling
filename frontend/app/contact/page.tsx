        ...
        <section className="section-panel p-6 sm:p-10 space-y-8">
            <div className="space-y-3">
              ...
              <div className="surface-card brand-panel space-y-2 p-4">
                ...
                <p className="text-sm text-slate-300">13a. If a document uploaded in Financial Analyses did not jump into the comparison summary automatically, include whether the file was newly uploaded on that tab or selected from an existing client document, and whether the scenario cards appeared at all.</p>
