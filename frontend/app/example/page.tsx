...
export const metadata: Metadata = {
  title: "Example Commercial Lease Financial Analysis",
  description:
    "View an example commercial real estate lease financial analysis generated by The CRE Model, including executive summary, lease economics, risk review, and client-ready PDF output.",
  alternates: { canonical: "/example" },
  openGraph: {
    title: "Example Commercial Lease Financial Analysis",
    description:
      "A client-ready commercial lease financial analysis example from The CRE Model.",
    url: "https://thecremodel.com/example",
  },
};
