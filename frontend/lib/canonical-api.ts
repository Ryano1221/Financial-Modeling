...
export function scenarioInputToBackendCanonical(
  ...
  return {
    ...
    opex_growth_rate: normalizeDecimalRate(s.opex_growth, 0.03),
...
export function backendCanonicalToScenarioInput(
  ...
  const scenario: ScenarioInput = {
    ...
    opex_growth: normalizeDecimalRate(c.opex_growth_rate, 0.03),
...
export function canonicalResponseToEngineResult(
  ...
  const metrics: OptionMetrics = {
    ...
    opexEscalationPercent: toNumber(normalized?.opex_growth_rate, 0.03),
